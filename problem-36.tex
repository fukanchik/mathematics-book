...
Рассмотрим почленно и начнём с $f(t)=t-8/3$. Это прямая. Найду корень:
$$t-8/3=0$$
откуда
$$t=8/3$$
...
С помощью этой картинки рассуждать очень просто. Ещё раз вспоминаем, что функции мы перемножаем. В промежутке $(-\infty;1]$ обе функции отрицательные. Минус на минус даёт плюс. Дальше - в промежутке $[1;\frac{8}{3}]$ одна функция меньше нуля а вторая - уже больше. Минус на плюс даёт минус. Ну и наконец третий промежуток - $[\frac{8}{3};+\infty)$. Тут уже обе прямых выше нуля а плюс на плюс даёт плюс.
