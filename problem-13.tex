...
Замена: $\sqrt{4-x^2}=a$. Работаю с $a$ как с переменной а $x$ с как с
константой:
$$\frac{x^3}{a}-a^2=0$$
$$\frac{x^3-a^3}{a}=0$$
$$x^3-a^3=0$$
...
$$x^2=2$$
$$x=\pm{}\sqrt{2}$$
$x=-\sqrt{2}$ не подходит, потому что она меньше нуля, а правая часть
$\sqrt{4-x^2}$ всегда больше нуля.
